...
router.post("/send_support_message", branchAdminAuth(UserRole.BRANCH_ADMIN), validateRequest(SupportValidation.createSupportSchema), SupportController.sendSupportMessage);
